/**
 * Run migration 050 - spending_category on transactions.
 * Usage: node scripts/run-migration-050.js
 * Or: npm run migrate:050
 */
const fs = require("fs");
...
async function main() {
  ...
  const migrationPath = path.join(
    ...
    "..",
    "migrations",
    "050_transaction_spending_category.sql"
  );
  ...
  console.log("Running migration 050 (transactions.spending_category)...");

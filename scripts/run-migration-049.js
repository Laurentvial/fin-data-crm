/**
 * Run migration 049 — invoices.bank_account_id.
 * Usage: node scripts/run-migration-049.js
 * Or: npm run migrate:049
 */
const fs = require("fs");
...
async function main() {
  ...
  const migrationPath = path.join(
    ...
    "..",
    "migrations",
    "049_invoice_bank_account_id.sql"
  );
  ...
  console.log("Running migration 049 (invoices.bank_account_id)...");

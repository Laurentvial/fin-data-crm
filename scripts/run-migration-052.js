/**
 * Run migration 052 - payment_by_card on invoices.
 * Usage: node scripts/run-migration-052.js
 * Or: npm run migrate:052
 */
const fs = require("fs");
...
async function main() {
  ...
  const migrationPath = path.join(
    ...
    "..",
    "migrations",
    "052_invoices_payment_by_card.sql"
  );

/**
 * Run migration 048 — credit_status on transactions.
 * Usage: node scripts/run-migration-048.js
 * Or: npm run migrate:048
 */
const fs = require("fs");
...
async function main() {
  ...
  const migrationPath = path.join(
    ...
    "..",
    "migrations",
    "048_transaction_credit_status.sql"
  );
  ...
  console.log("Running migration 048 (transactions.credit_status)…");
